...
function FlexGrid( props ) {
    ...
    return (
        <>
            <Helmet>
                <title>Porto React Ecommerce - Category Flex Grid</title>
            </Helmet>
            ...
            <div className="main">
                ...
                <div className="container skeleton-body skel-shop-products">
                    ...
                    <Pagination count={ productCount } curPage={ onChangeCurPage } productType="flex-grid" layout={ layout } changeDisplay={ onChangeDisplayCount } displayCount={ displayCount } />
                </div>
